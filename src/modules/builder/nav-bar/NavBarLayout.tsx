...
const NavBarLayout = () => {
  ...
  return (
    <nav className="h-14 w-full border-b-2 border-gray-100 bg-[#fff] relative flex py-2.5 pl-5 pr-4 items-center z-20 print:hidden">
      <Link href="/">
        <Image className='inline-block' src={resumeIcon} alt="logo" height="36" width="36" />
      </Link>
      <div className="flex-auto flex justify-between items-center ml-5 transform scale-[0.8] translate-x-[-15%] sm:scale-100 sm:translate-x-0">
        <NavBarMenu>
          <NavMenuItem
